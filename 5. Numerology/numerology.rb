#Numerology
puts "Want to find out what your birthdate says about you?  Then enter your birthdate in the form of MMDDYYYY"
birthdate = gets
...
if final_number > 9
  then final_number = birthdate[0].to_i + birthdate[1].to_i

end

puts "Your birthdate number is #{final_number}"
